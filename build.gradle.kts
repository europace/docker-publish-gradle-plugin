...
val kotlinVersion = "1.8.21" // remember to update in plugins
val kotlinxVersion = "1.6.4"
val mockkVersion = "1.13.5"

plugins {
  kotlin("jvm") version "1.8.21" // remember to update in dependency
...
dependencies {
  ...
  implementation("de.gesellix:gradle-docker-plugin:2023-04-06T00-22-00")
